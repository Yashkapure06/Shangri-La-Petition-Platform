import nft1 from "../../../../assets/img/dashboards/dashboard-banner.png";
    ...
    >
      <div className="w-full">
        ...
        <p className=" max-w-full text-base font-medium text-[#E3DAFF] md:w-[64%] lg:w-[40%] xl:w-[72%] 2xl:w-[60%] 3xl:w-[45%]">
          {isAdmin
            ? "Here you can manage your Petitions, view all petitions, threshold signatures, and more."
            : "Here you can view and sign Petitions from various creators."}
        </p>
      </div>
    </div>
  );
